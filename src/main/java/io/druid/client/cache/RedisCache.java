...
public class RedisCache implements Cache
{
    ...
    public void doMonitor(ServiceEmitter emitter)
    {
        ...
        emitter.emit(builder.build("query/cache/redis/delta/requests", totalRequestCount.get() - priorRequestCount.get().get()));
        if (!priorRequestCount.compareAndSet(priorRequestCount.get(), totalRequestCount)) {
